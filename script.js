...
window.addEventListener('load', () => {
    ...
    targetDiv.scrollIntoView({
        behavior: 'auto', // use 'smooth' for a smooth transition
        block: 'center',  // aligns the center of the element with the center of the viewport along the vertical axis
        inline: 'center'  // aligns the center of the element with the center of the viewport along the horizontal axis
    });
});
